...
let
  ...
  luaPath =
    "${config.home.homeDirectory}/codes/jackwy/jackwy-nixos/modules/home-manager/lazyvim/lua";
in {
  options.${moduleNameSpace}.lazyvim = {
    enable = mkEnableOption "User Lazyvim";
  };
  ...
  config = mkIf cfg.enable {
    ...
    xdg.configFile."nvim/lua".source =
      config.lib.file.mkOutOfStoreSymlink luaPath;
